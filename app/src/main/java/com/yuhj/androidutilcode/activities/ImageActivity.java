...
import com.yuhj.utilcode.utils.ImageUtils;
import com.yuhj.utilcode.utils.SizeUtils;
...
public class ImageActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ivAddTextWatermark.setImageBitmap(ImageUtils.addTextWatermark(src, "yuhj", 40, 0x8800ff00, 0, 0));
